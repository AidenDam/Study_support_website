        ...
        <div class="container" style="height: 80px">
            <div class="page-header">
                <div class="logo pull-left">
                    <div class="pull-left">
                        <a class="navbar-brand" href="/site/index" style="padding:0px;">
                            <img src="<?= Yii::getAlias('@web') ?>/images/logo.png" style="height: 80px; width: 80px;" >
                        </a>
                    </div>
                    <div class="brand">
                        Olympic HaUI
                ...
                <div class="pull-right">
                    <a></a>
                    <a href="/contest/index?lang=en-US&<?= preg_replace('/(lang=en-US&*)|(lang=vi&*)|&$/i', '', $_SERVER['QUERY_STRING']) ?>"><img src="<?= Yii::getAlias('@web') ?>/images/uk.ico" alr="English" width="50px" height="50px"></a> <a href="/contest/index?lang=vi&<?= preg_replace('/(lang=en-US&*)|(lang=vi&*)|&$/i', '', $_SERVER['QUERY_STRING']) ?>"><img src="<?= Yii::getAlias('@web') ?>/images/vn.ico" alr="Tieng Viet" width="50px" height="50px"></a>
...
<footer class="footer">
    <div class="text-center">
        <p class="text-info">
            <a href="https://www.facebook.com/profile.php?id=100015560746629"><img src="<?= Yii::getAlias('@web') ?>/images/facebook.ico"> Facebook   |   </a>
            <a href="https://www.youtube.com/@oiolympictinhoc-aihoccongn4763"><img src="<?= Yii::getAlias('@web') ?>/images/youtube.ico"> Youtube   |   </a>
            <a href="https://github.com/AidenDam"><img src="<?= Yii::getAlias('@web') ?>/images/github.ico"> Github </a>
        </p>
        <p>Base on <a href="http://www.hustoj.org">HUSTOJ</a></p>
    </div>
</footer>
<?php $this->endBody() ?>
<script>
